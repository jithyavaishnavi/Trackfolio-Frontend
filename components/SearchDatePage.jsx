...
export default function SearchDatePage() {
  ...
  <h2 className="text-4xl font-bold mb-12 text-[#F5F5DC] text-center">
    Searched Drives
  </h2>
  ...
  <div className="relative mb-6 flex justify-center">
    <input
      ...
      className="border border-[#F5F5DC]/40 bg-black/50 text-[#F5F5DC] p-2 rounded-lg focus:outline-none"
    />
  </div>
