...
>
  <section className="mt-30 mb-12 max-w-6xl mx-auto px-4">
    <h2 className="text-3xl font-bold mb-3 text-[#F5F5DC] text-center">
      Completed Drives
    </h2>
    <p className="text-sm text-[#F5F5DC] text-center mb-30">
      Drives held in the past
    </p>
