...
>
  ...
  <a
    ...
    className="flex items-center gap-3 bg-[#A7D16C] text-black px-6 py-3 rounded-full font-semibold hover:bg-[#F5F5DC] hover:text-[#A7D16C] transition-colors duration-300"
  >
