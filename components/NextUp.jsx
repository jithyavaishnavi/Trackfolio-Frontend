...
const getAuthToken = () => {
  return "your-secure-access-token"; 
};

const API_URL =
  process.env.NEXT_PUBLIC_API_URL ||
  "http://localhost:8080/drives/type?type=nextup";
...
          setError(errorData.message || "Failed to fetch next up companies.");
...
            time: new Date(drive.driveDatetime).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })
        }));
